...
def parse_kgat_args(opts = sys.argv[1:]):
    ...
    parser.add_argument('--data_name', nargs='?', default='baekjun',
                        help='Choose a dataset from {yelp2018, last-fm, last-fm}')
    ...
    parser.add_argument('--lr', type=float, default=0.0001,
                        help='Learning rate.')
    parser.add_argument('--n_epoch', type=int, default=1, # 1000
...
print('Best CF Evaluation: Epoch {:04d} | Precision [{:.4f}, {:.4f}], Recall [{:.4f}, {:.4f}], NDCG [{:.4f}, {:.4f}]'.format(
